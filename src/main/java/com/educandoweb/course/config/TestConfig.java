...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        User u2 = new User("Alex Green", "alex@gmail.com", "9777777777", "123456");

        Order o1 = new Order(Instant.parse("2019-06-20T19:53:07Z"), OrderStatus.PAID,u1);
        Order o2 = new Order(Instant.parse("2019-07-21T03:42:07Z"), OrderStatus.WAITING_PAYEMENT, u2);
        Order o3 = new Order(Instant.parse("2019-07-22T15:21:07Z"), OrderStatus.WAITING_PAYEMENT,u1);
